...
import AnalyticsComponent from "@/app/components/AnalyticsComponent";
    ...
    return (
        <div>
            <main
                ...
                <div className={"grid grid-cols-6 grid-rows-10 h-screen w-screen p-4 gap-2"}>
                    <div className={"col-start-1 row-start-1 bg-white rounded-xl flex flex-row gap-2 px-6 justify-center items-center border border-slate-300 drop-shadow-lg"}>
                        <svg width="40" height="40" viewBox="0 0 116 139" fill="none"
                            ...
                            <path
                                ...
                                fill="black"/>
                            <path d="M9.1843 116.092H0.077179V110.086H6.86893L9.1843 108.742V116.092Z" fill="black"/>
                            <path
                        ...
                        <span className={"font-extrabold text-lg text-center font-inknut"}>BEKAWAVE LIMITED</span>
                    </div>
                    <div className={`col-start-1 row-start-2 row-span-9 bg-white border border-slate-300 rounded-xl drop-shadow-lg p-2`}>
                        {/*<AnalyticsComponent/>*/}
                    </div>
                    <div className={`col-start-2 row-start-1 col-span-4 row-span-full bg-white border border-slate-300 rounded-xl drop-shadow-lg`}>

                    </div>

                    <div className={"col-start-6 row-start-1 row-span-full bg-white border border-slate-300 rounded-xl drop-shadow-lg p-2"}>
                        <Timeline />
                    </div>
                </div>
                <div>
