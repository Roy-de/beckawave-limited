    ...
    <DefaultLayout>
      ...
      >
        ...
        >
          ...
          <span className={"font-extrabold text-lg text-center text-black"}>
            BEKAWAVE LIMITED
          </span>
        </div>
        <div
          className={`col-start-1 row-start-2 row-span-full bg-white bg-opacity-20 backdrop-blur-3xl rounded-lg drop-shadow-lg p-2`}
        />
        <div
          className={`col-start-2 row-start-1 col-span-4 row-span-full bg-white bg-opacity-20 backdrop-blur-3xl rounded-lg drop-shadow-lg`}
        />

        <div
          className={
            "col-start-6 row-start-1 row-span-full bg-white bg-opacity-20 backdrop-blur-3xl rounded-lg drop-shadow-lg p-2"
          }
        />
      </div>
      <div>
